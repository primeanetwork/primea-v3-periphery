...
import '@primea/v3-core/contracts/libraries/TickBitmap.sol';
...
contract QuoterV2 is IQuoterV2, IPrimeaV3SwapCallback, PeripheryImmutableState {
    ...
    function primeaV3SwapCallback(
        ...
        IPrimeaV3Pool pool = getPool(tokenIn, tokenOut, fee);
        ...
        )
    {
        ...
        IPrimeaV3Pool pool = getPool(params.tokenIn, params.tokenOut, params.fee);
        ...
        )
    {
        ...
        {} catch (bytes memory reason) {
            ...
            (uint256 parsedAmountIn, uint160 parsedSqrtPriceX96After, int24 parsedTickAfter) = parseRevertReason(reason);
            (, int24 tickBefore, , , , , ) = pool.slot0();
            uint32 ticksCrossedAfter = pool.countInitializedTicksCrossed(tickBefore, parsedTickAfter);
