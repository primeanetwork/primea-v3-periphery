import { abi as IPrimeaV3PoolABI } from '@primea/v3-core/artifacts/contracts/interfaces/IPrimeaV3Pool.sol/IPrimeaV3Pool.json'
import { Fixture } from 'ethereum-waffle'
import { BigNumber, constants, ContractTransaction, Wallet } from 'ethers'
import { ethers, waffle } from 'hardhat'
import { IPrimeaV3Pool, IWETH9, MockTimeSwapRouter, TestERC20 } from '../typechain'
...
describe('SwapRouter gas tests', function () {
  ...
  const swapRouterFixture: Fixture<{
    ...
    pools: [IPrimeaV3Pool, IPrimeaV3Pool, IPrimeaV3Pool]
    ...
    const pools = poolAddresses.map((poolAddress) => new ethers.Contract(poolAddress, IPrimeaV3PoolABI, wallet)) as [
      IPrimeaV3Pool,
      IPrimeaV3Pool,
      IPrimeaV3Pool
    ]
  ...
  let pools: [IPrimeaV3Pool, IPrimeaV3Pool, IPrimeaV3Pool]
  ...
  describe('#exactInput', () => {
    ...
    it('0 -> 1 minimal', async () => {
      const calleeFactory = await ethers.getContractFactory('TestPrimeaV3Callee')
